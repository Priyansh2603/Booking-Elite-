...
const Hello = () => {
    ...
    users.map((user) => {
        if (user.Property === value) {
            ...
            return <h1>Contact : {user.Contact}</h1>;
            // name.map((i)=>{
            // return (<>
                ...
                <>
                    <div className="container-Hello">
                        ...
                        <section>
                            <div>
                                <h1>
                                    <span id="property_type1">{Lift}</span>
                                </h1>
                                <h2>
                                    <span id="property_type2"></span>
                                </h2>
                                <table>
                                    <thread>
                                        <tr>
                                ...
                                >
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td id="A3">{Washroom_A}</td>
                                            <td>
                                                <a onClick="link3()" id="vid3">
                                                    {Wheelchair_B}
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td id="A4">{Washroom_A}</td>
                                            <td>
                                                <a onClick="link4()" id="vid4">
                                                    {Washroom_B}
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td id="f5">{Braille}</td>
                                            <td id="A5">{Braille_A}</td>
                                            <td>
                                                <a onClick="link5()" id="vid5">
                                                    {Braille_B}
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <button className="btn btn-info btn-lg ms-2">
                                <a
                            ...
                            <button className="btn btn-warning btn-lg ms-2">
                                <a
                                    href={`https://book.olacabs.com/?serviceType=p2p&when=NOW&utm_source=widget_on_olacabs&pickup_name=Current%20Location&drop_lat=10.8945458&drop_lng=76.9970671&drop_name="${i.Address}"&pickup=current_location`}
                                    target="_blank"
                                >
                                    Cab Service
                                </a>
